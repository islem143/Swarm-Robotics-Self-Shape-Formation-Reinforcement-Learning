...
bool mrs_msg__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msg.msg._sphere.Sphere", full_classname_dest, 26) == 0);
  }
  mrs_msg__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * mrs_msg__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msg.msg._sphere");
