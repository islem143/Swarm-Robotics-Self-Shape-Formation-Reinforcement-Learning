...
bool mrs_msg__srv__add_three_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msg.srv._add_three_ints.AddThreeInts_Request", full_classname_dest, 48) == 0);
  }
  mrs_msg__srv__AddThreeInts_Request * ros_message = _ros_message;
  {  // a
...
PyObject * mrs_msg__srv__add_three_ints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msg.srv._add_three_ints");
...
ROSIDL_GENERATOR_C_EXPORT
bool mrs_msg__srv__add_three_ints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msg.srv._add_three_ints.AddThreeInts_Response", full_classname_dest, 49) == 0);
  }
  mrs_msg__srv__AddThreeInts_Response * ros_message = _ros_message;
  {  // sum
