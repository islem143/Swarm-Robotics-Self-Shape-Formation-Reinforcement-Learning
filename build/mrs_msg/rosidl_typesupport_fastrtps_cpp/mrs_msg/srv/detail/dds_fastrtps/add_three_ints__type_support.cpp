...
#include "mrs_msg/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msg
cdr_serialize(
  const mrs_msg::srv::AddThreeInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msg::srv::AddThreeInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
...
{
  auto typed_message =
    static_cast<const mrs_msg::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msg::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mrs_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<mrs_msg::srv::AddThreeInts_Request>()
{
  return &mrs_msg::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msg, srv, AddThreeInts_Request)() {
  return &mrs_msg::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msg
cdr_serialize(
  const mrs_msg::srv::AddThreeInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msg::srv::AddThreeInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
...
{
  auto typed_message =
    static_cast<const mrs_msg::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mrs_msg::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mrs_msg::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msg, srv, AddThreeInts_Response)() {
  return &mrs_msg::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &mrs_msg::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msg, srv, AddThreeInts)() {
  return &mrs_msg::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
