...
#include "mrs_msg/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msg::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msg::msg::Sphere & ros_message)
{
  // Member: center
...
{
  auto typed_message =
    static_cast<const mrs_msg::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msg::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &mrs_msg::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msg, msg, Sphere)() {
  return &mrs_msg::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
