...
#include "mrs_msg/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mrs_msg::msg::Num *>(
    untyped_ros_message);
...
{
  return &mrs_msg::msg::typesupport_fastrtps_cpp::_Num__handle;
}
