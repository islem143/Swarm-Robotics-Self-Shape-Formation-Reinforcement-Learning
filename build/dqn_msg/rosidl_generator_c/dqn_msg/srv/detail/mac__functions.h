...
#ifndef DQN_MSG__SRV__DETAIL__MAC__FUNCTIONS_H_
#define DQN_MSG__SRV__DETAIL__MAC__FUNCTIONS_H_
...
/// Create srv/Mac message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dqn_msg__srv__Mac_Request__init().
...
/// Destroy srv/Mac message.
/**
 * It calls
 * dqn_msg__srv__Mac_Request__fini()
...
/// Check for srv/Mac message equality.
/**
...
/// Initialize array of srv/Mac messages.
/**
...
/// Finalize array of srv/Mac messages.
/**
 * It calls
 * dqn_msg__srv__Mac_Request__fini()
...
/// Create array of srv/Mac messages.
/**
 * It allocates the memory for the array and calls
 * dqn_msg__srv__Mac_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Mac messages.
/**
 * It calls
 * dqn_msg__srv__Mac_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Mac message array equality.
/**
...
/// Copy an array of srv/Mac messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dqn_msg__srv__Mac_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dqn_msg
...
/**
 * It calls
 * dqn_msg__srv__Mac_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dqn_msg
...
/**
 * It allocates the memory for the array and calls
 * dqn_msg__srv__Mac_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dqn_msg
...
/**
 * It calls
 * dqn_msg__srv__Mac_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DQN_MSG__SRV__DETAIL__MAC__FUNCTIONS_H_
