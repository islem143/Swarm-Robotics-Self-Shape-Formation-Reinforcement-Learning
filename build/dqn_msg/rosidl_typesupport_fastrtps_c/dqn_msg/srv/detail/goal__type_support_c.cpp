...
#include "dqn_msg/srv/detail/goal__rosidl_typesupport_fastrtps_c.h"
...
using _Goal_Request__ros_msg_type = dqn_msg__srv__Goal_Request;
...
size_t get_serialized_size_dqn_msg__srv__Goal_Request(
  const void * untyped_ros_message,
...
static uint32_t _Goal_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dqn_msg__srv__Goal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dqn_msg
size_t max_serialized_size_dqn_msg__srv__Goal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Goal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dqn_msg__srv__Goal_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dqn_msg, srv, Goal_Request)() {
...
using _Goal_Response__ros_msg_type = dqn_msg__srv__Goal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dqn_msg
size_t get_serialized_size_dqn_msg__srv__Goal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Goal_Response__ros_msg_type * ros_message = static_cast<const _Goal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dqn_msg__srv__Goal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dqn_msg
size_t max_serialized_size_dqn_msg__srv__Goal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Goal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dqn_msg__srv__Goal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dqn_msg, srv, Goal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dqn_msg, srv, Goal)() {
  return &Goal__handle;
}
