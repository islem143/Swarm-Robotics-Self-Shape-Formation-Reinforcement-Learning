...
#include "dqn_msg/msg/detail/goal__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // goal
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // goal

// forward declare type support functions


using _Goal__ros_msg_type = dqn_msg__msg__Goal;
...
size_t get_serialized_size_dqn_msg__msg__Goal(
  const void * untyped_ros_message,
...
static uint32_t _Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dqn_msg__msg__Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dqn_msg
size_t max_serialized_size_dqn_msg__msg__Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dqn_msg__msg__Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dqn_msg, msg, Goal)() {
