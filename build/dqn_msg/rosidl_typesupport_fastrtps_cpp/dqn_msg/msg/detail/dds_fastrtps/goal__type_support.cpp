...
#include "dqn_msg/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const dqn_msg::msg::Goal *>(
    untyped_ros_message);
...
{
  return &dqn_msg::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
