...
{
  new (message_memory) dqn_msg::srv::Goal_Request(_init);
}

void Goal_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dqn_msg::srv::Goal_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Goal_Request_message_member_array[1] = {
  {
    ...
    offsetof(dqn_msg::srv::Goal_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Goal_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(dqn_msg::srv::Goal_Request),
...
{
  return &::dqn_msg::srv::rosidl_typesupport_introspection_cpp::Goal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dqn_msg, srv, Goal_Request)() {
  return &::dqn_msg::srv::rosidl_typesupport_introspection_cpp::Goal_Request_message_type_support_handle;
}
...
void Goal_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) dqn_msg::srv::Goal_Response(_init);
}

void Goal_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dqn_msg::srv::Goal_Response *>(message_memory);
  typed_message->~Goal_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Goal_Response_message_member_array[2] = {
  {
    "x",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dqn_msg::srv::Goal_Response, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dqn_msg::srv::Goal_Response, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Goal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(dqn_msg::srv::Goal_Response),
...
{
  return &::dqn_msg::srv::rosidl_typesupport_introspection_cpp::Goal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dqn_msg, srv, Goal_Response)() {
  return &::dqn_msg::srv::rosidl_typesupport_introspection_cpp::Goal_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Goal_service_members = {
  ...
  // see get_service_type_support_handle<dqn_msg::srv::Goal>()
...
get_service_type_support_handle<dqn_msg::srv::Goal>()
{
  ...
  auto service_type_support =
    &::dqn_msg::srv::rosidl_typesupport_introspection_cpp::Goal_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dqn_msg, srv, Goal)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<dqn_msg::srv::Goal>();
}
