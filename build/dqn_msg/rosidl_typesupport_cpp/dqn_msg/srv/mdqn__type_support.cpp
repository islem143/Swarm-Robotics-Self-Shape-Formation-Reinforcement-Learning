...
static const _Mdqn_Request_type_support_symbol_names_t _Mdqn_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dqn_msg, srv, Mdqn_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dqn_msg, srv, Mdqn_Request)),
  }
};
...
{
  return &::dqn_msg::srv::rosidl_typesupport_cpp::Mdqn_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dqn_msg, srv, Mdqn_Request)() {
  return get_message_type_support_handle<dqn_msg::srv::Mdqn_Request>();
}
...
static const _Mdqn_Response_type_support_symbol_names_t _Mdqn_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dqn_msg, srv, Mdqn_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dqn_msg, srv, Mdqn_Response)),
  }
};
...
{
  return &::dqn_msg::srv::rosidl_typesupport_cpp::Mdqn_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dqn_msg, srv, Mdqn_Response)() {
  return get_message_type_support_handle<dqn_msg::srv::Mdqn_Response>();
}
...
static const _Mdqn_type_support_symbol_names_t _Mdqn_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dqn_msg, srv, Mdqn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dqn_msg, srv, Mdqn)),
  }
};
...
{
  return &::dqn_msg::srv::rosidl_typesupport_cpp::Mdqn_service_type_support_handle;
}
