...
Once the message received by other robots, each one of them will try to reach the target goal autonomously by avoiding collision with other robots.
...
This information will be stored in a replay buffer, and once it reach a certain number of experiences the training starts.
