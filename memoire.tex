...
In order to achieve the target shape formation, state and reward  are critical component  of RL as  they representation will affect direcly the performance of our robot and will determine the neurel network architecutre.
