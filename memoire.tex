...
It consists of a simulator that can be used to spawn robots, design  environement , put obstacles , run diffrents expiriments, all this with real  interaction and simulation of the real world   phisics.
