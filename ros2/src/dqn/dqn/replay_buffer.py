...
class ReplayBuffer():
    ...
    def add_record(self, states,next_states,rewards,dones,actions):
        ...
        #     self.actor_states[i][index]=states[i*self.state_size:i*self.state_size+self.state_size]
        #     self.actor_next_states[i][index]=next_states[i*self.state_size:i*self.state_size+self.state_size]
    ...
    def get_minibatch(self,batch_size):
        ...
        return states_batch,next_states_batch,rewards_batch,dones,actions_batch
