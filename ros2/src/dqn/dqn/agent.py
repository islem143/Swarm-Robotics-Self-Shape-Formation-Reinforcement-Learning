...
class Agent():
    def __init__(self, name,model_load=False, ep=0,test=False,num_agents=1,state_size=30,action_size=1) -> None:
        self.name = name
    ...
    def create_critic_model(self):
        ...
        # state_out = keras.layers.BatchNormalization()(state_out)
            ...
            # Action as input
        action_input = keras.layers.Input(shape=(self.num_agents*self.action_size))
